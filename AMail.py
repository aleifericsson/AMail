...
button_list.append(Button("Login",400,300,60,20,GRAY,"Login")) #0
button_list.append(Button("To Sign Up",370,500,120,20,GRAY,"Login"))
button_list.append(Button("Show?",760,230,70,20,GRAY,"Login"))
button_list.append(Button("To Login", 370,500,120,20,GRAY,"Sign_Up")) #3
button_list.append(Button("Sign Up",400,300,80,20,GRAY,"Sign_Up"))
button_list.append(Button("Make Email",750,70,120,20,GRAY,"Main")) #5
button_list.append(Button("Logout",160,70,80,20,GRAY,"Main"))
button_list.append(Button("Emails Received",10,120,120,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("Emails Sent",10,150,120,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("All accounts",10,180,120,15,LIGHTER_GRAY,"Main")) #9
button_list.append(Button("Descending?",10,240,100,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("Sort by date",10,300,100,15,LIGHTER_GRAY,"Main")) #11
button_list.append(Button("Sort by sender",10,330,100,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("Sort by subject",10,360,100,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("Sort by name",10,330,100,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("Sort by recips",10,330,100,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("Sort by address",10,360,100,15,LIGHTER_GRAY,"Main"))
button_list.append(Button("< Prev page",520,70,100,15,LIGHTER_GRAY, "Main"))
button_list.append(Button("Next page >",630,70,100,15,LIGHTER_GRAY, "Main"))
button_list.append(Button("Back to Main",160,70,160,20,GRAY,"Make")) #19
button_list.append(Button("Submit Email",160,500,160,20,GRAY,"Make"))
button_list.append(Button("Add Recipient",160,230,170,20,GRAY,"Make"))
button_list.append(Button("Reset",160,200,100,20,GRAY,"Make"))
button_list.append(Button("Show?",760,260,70,20,GRAY,"Sign_Up"))
button_list.append(Button("Exit",370,450,120,20,GRAY,"Login"))#24

email_buttons.append(Button("Email 1",150,100,730,50,WHITE,"Main")) #1
email_buttons.append(Button("Email 2",150,150,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 3",150,200,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 4",150,250,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 5",150,300,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 6",150,350,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 7",150,400,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 8",150,450,730,50,WHITE,"Main"))
email_buttons.append(Button("Email 9",150,500,730,50,WHITE,"Main"))

textbox_list.append(Textbox("Address",350,200,400,20,"Login")) #0
textbox_list.append(Textbox("Password",350,230,400,20,"Login"))
textbox_list.append(Textbox("Add_Name",350,200,400,20,"Sign_Up")) #2
textbox_list.append(Textbox("Add_Address",350,230,400,20,"Sign_Up"))
textbox_list.append(Textbox("Add_Password",350,260,400,20,"Sign_Up"))
textbox_list.append(Textbox("Email_Subject",350,110,500,20,"Make")) #5
textbox_list.append(Textbox("Email_Recipients",350,140,500,20,"Make"))
textbox_list.append(Textbox("Email_Content",350,170,500,360,"Make",18))
...
# ---    Drawing Base Background    --- #
    ...
    pygame.draw.rect(screen, GRAY, [0,0,150,600])
    pygame.draw.rect(screen, GRAY, [880,0,20,600])
    pygame.draw.rect(screen, DARK_GRAY, [0,550,900,50])
    pygame.draw.rect(screen, DARK_GRAY, [0,20,900,40])
    pygame.draw.rect(screen, LIGHTER_GRAY, [0,0,150,20])
    pygame.draw.rect(screen, LIGHT_GRAY, [150,0,150,20])
    pygame.draw.rect(screen, LIGHTER_GRAY, [300,0,150,20])
    pygame.draw.rect(screen, LIGHT_GRAY, [450,0,150,20])
    pygame.draw.rect(screen, LIGHTER_GRAY, [600,0,150,20])
    pygame.draw.rect(screen, LIGHT_LIGHTER_GRAY, [750,0,150,20])
    pygame.draw.rect(screen, WHITE, [150, 30, 740, 20])
    font = pygame.font.SysFont("Calibri",18,True,False)
    text = font.render("Made by Alif Nafili", True, BLACK)
    screen.blit(text,[756,1])

# ---    Drawing Login Screen    --- #
    if current_screen == "Login":
        font = pygame.font.SysFont("Calibri",20,True,False)
        pygame.draw.rect(screen, GRAY, [0,0,150,20])
        text = font.render("AMail.com - Login", True, WHITE)
        screen.blit(text,[8,1])
        font = pygame.font.SysFont("Calibri",20,True,False)
        text = font.render("Email Address:", True, BLACK)
        screen.blit(text,[155,200])
        text = font.render("Password:", True, BLACK)
        screen.blit(text,[155,230])
        if wrong_password == True:
            text = font.render("Wrong email or password entered.", True, WHITE)
            screen.blit(text,[155,260])
        for i in button_list:
            if i.page == "Login":
                i.draw()
            else:
...
# ---    Drawing Sign-Up Screen    --- #
        ...
        font = pygame.font.SysFont("Calibri",20,True,False)
        pygame.draw.rect(screen, GRAY, [150,0,150,20])
        text = font.render("AMail.com - Sign up", True, WHITE)
        screen.blit(text,[151,1])
        font = pygame.font.SysFont("Calibri",20,True,False)
...
# ---    Drawing Main Screen    --- #
        ...
        font = pygame.font.SysFont("Calibri",20,True,False)
        pygame.draw.rect(screen, GRAY, [300,0,150,20])
        text = font.render("AMail.com - Main", True, WHITE)
        screen.blit(text,[301,1])
        pygame.draw.rect(screen,LIGHT_GRAY, [150,60,730,40])
        pygame.draw.rect(screen, LIGHT_LIGHTER_GRAY, [150,150,730,50])
        pygame.draw.rect(screen, LIGHT_LIGHTER_GRAY, [150,250,730,50])
        pygame.draw.rect(screen, LIGHT_LIGHTER_GRAY, [150,350,730,50])
        pygame.draw.rect(screen, LIGHT_LIGHTER_GRAY, [150,450,730,50])
        text = font.render("Hello, "+current_user.name, True, BLACK)
        screen.blit(text,[250,71])
        font = pygame.font.SysFont("Calibri",20,False,False)
        text = font.render("Page: "+str(page), True, WHITE)
        screen.blit(text,[400,71])
        for i in textbox_list:
            if i.page == "Main":
                i.draw()
            else:
        ...
        if current_display == "Emails_Got":
            ...
            for i in range(len(account_display)%9):
                ...
                screen.blit(text,[155,100+i*50+5])
